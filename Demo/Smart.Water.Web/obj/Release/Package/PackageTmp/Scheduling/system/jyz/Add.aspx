<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Smart.Water.Web.Scheduling.system.jyz.WebForm1" %>
            ...
            try {
                if (typeInfo == 'success') {
                    ...
                    window.setTimeout(function () {
                        parent.Robin.CloseOneInfoPanel("Add");
                    }, 1000);
                }
            }
            catch (e) {
            ...
            <div class="tab-pane fade" id="cbf">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td>出泵房</td>
                        <td>
                            <asp:TextBox ID="txt_CBF" CssClass="form-control" runat="server"></asp:TextBox>
                        </td>
                        <td>出泵管径(mm)</td>
                        <td>
                    ...
                    <tr>
                        <td>噪声等级</td>
                        <td>
                            <asp:TextBox ID="txt_ZSDJ" CssClass="form-control" runat="server"></asp:TextBox>
                        </td>                       
                    </tr>
                </table>
            </div>

            <div class="tab-pane fade active  in" id="bz">
            </div>
        </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SYJEdit.aspx.cs" Inherits="Smart.Water.Web.Scheduling.system.syj.SYJEdit" %>
            ...
            try {
                if (typeInfo == 'success') {
                    ...
                    window.setTimeout(function () {
                        parent.Robin.CloseOneInfoPanel("SYJEdit");
                    }, 1000);
                }
            }
            catch (e) {
            ...
            <div class="tab-pane fade active in" id="home">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>联系人</td>
                        <td>
                            <asp:TextBox ID="txt_LXR" CssClass="form-control required" runat="server"></asp:TextBox>
                        </td>
                        <td>联系电话</td>
                        <td>
                    ...
                    <tr>
                        <td>施工单位</td>
                        <td>
                            <asp:TextBox ID="txt_SGDW" CssClass="form-control required" runat="server"></asp:TextBox>
                        </td>
                        <td>权属单位</td>
                        <td>
                            <asp:TextBox ID="txt_QSDW" CssClass="form-control required" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>行政区</td>

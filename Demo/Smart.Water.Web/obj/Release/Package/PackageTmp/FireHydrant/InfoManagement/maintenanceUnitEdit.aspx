<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="maintenanceUnitEdit.aspx.cs" Inherits="Smart.Water.Web.FireHydrant.InfoManagement.WebForm1" %>
        ...
        <table class="table table-bordered">
            ...
            <tr>
              ...
              <tr>
                ...
                <td colspan="3">               
                    <input  type="text" id="txt_ADDRESS" class="form-control" runat="server" style="width: 96%" />
                </td>
            </tr>
            <tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="maintenancePersonAdd.aspx.cs" Inherits="Smart.Water.Web.FireHydrant.InfoManagement.WebForm3" %>
   ...
   <title>维保人员添加</title>
    ...
    <script>
        ...
        jQuery.validator.addMethod("age", function (value, element) {
            var mobile = /^(?:[1-9][0-9]?|1[01][0-9]|120)$/i;
            return this.optional(element) || mobile.test(value);
        }, "请输入0到120之间的整数");      
    ...
    <form id="ProForm" runat="server" class="form-horizontal row-border">
        <table class="table table-bordered">
            <tr>
                ...
                <td>
                    <input type="text" class="form-control" runat="server" id="txt_UNITNAME" />
                </td>
            ...
            <tr>
                <td style="vertical-align:middle;" class="td_justify"><span>姓名</span></td>
                <td class="respan">
                    <input type="text" class="form-control  required  " runat="server" id="txt_NAME" /><span>*</span>
                </td>             
                <td style="vertical-align:middle;" class="td_justify"><span>性别</span></td>
                <td>     
            ...
            <tr>
                <td style="vertical-align:middle;" class="td_justify"><span>民族</span></td>
                <td>
                    <input type="text" class="form-control" runat="server" id="txt_NATION" />
                </td>
                <td style="vertical-align:middle;" class="td_justify"><span>出生日期</span></td>
                <td>
                    <input type="text" class="form-control" runat="server" id="txt_BORN" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd', maxDate: '%y-%M-%d' })" />

                </td>
<%--             <td style="vertical-align:middle;" class="td_justify"><span>年龄</span></td>
                <td class="respan">
...
<%--            <tr>
                ...
                <td style="vertical-align:middle;" class="td_justify"><span>身份证号</span></td>
                <td>
                    <input type="text" class="form-control idcard" runat="server" id="txt_IDCARD" />
                </td>
            </tr>--%>
            <tr>  
                <td style="vertical-align:middle;" class="td_justify"><span>入职时间</span></td>
                <td>
                    <input type="text" class="form-control" runat="server" id="txt_ENTRYTIME" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd', maxDate: '%y-%M-%d' })" />
                </td>              
                <td style="vertical-align:middle;" class="td_justify"><span>联系电话</span></td>
                <td>

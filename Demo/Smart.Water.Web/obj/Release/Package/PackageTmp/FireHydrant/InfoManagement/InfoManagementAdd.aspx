<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InfoManagementAdd.aspx.cs" Inherits="Smart.Water.Web.FireHydrant.InfoManagement.InfoManagementAdd" %>
...
<body>
    <form id="ProForm" runat="server" class="form-horizontal row-border">
        <table class="table table-bordered">
            <tr>
                <td style="vertical-align:middle;" class="td_justify">
                    <span>管点编号</span>
                </td>
                <td class="respan">
            ...
            <tr>
                ...
                <td class="respan">
                    <asp:DropDownList ID="ddl_EMBED" runat="server" CssClass="form-control  required " Style="width: 283px">
            ...
            <tr>
                ...
                <td>
                    <select class="form-control" id="txtBMMC" runat="server" style="width: 283px">
                        <option value='0'>-请选择-</option>
                    </select>                    
            ...
            <tr>
                <td style="vertical-align:middle;"><input type="button" class="btn btn-sm btn-success" value="拾取" style="padding:4px" id="btnSelect" />X坐标</td>
                <td>
                    <input type="text" class="form-control  number  required" runat="server" id="txt_X" />
                </td>
                <td style="vertical-align:middle;" class="td_justify">
                    <span>Y坐标</span>
                </td>
                <td>
                    <input type="text" class="form-control  number  required" runat="server" id="txt_Y" />
                </td>
            </tr>
            <tr>
                <td style="vertical-align:middle;" class="td_justify">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assertAdd.aspx.cs" Inherits="Smart.Water.Web.FireHydrant.HyrantAssert.assertAdd" %>
                ...
                success: function (data) {                    
                    ...
                    $.each(data, function (i,v) {
                        if (v.HYDRANTTYPE == "地上") {
                            ...
                            dxhtml += '<input type="checkbox" name="dxbyBox" value=' + v.ID + ' style="margin: 0 2px 2px" /><span>' + v.ACONTENT + '</span><br />';
                        }
                    })
                    $("#DSBY").append(dshtml);
                    $("#DXBY").append(dxhtml);
            ...
            <div class=" form-group">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td style="width: 38%;vertical-align:middle;">
                          <input type="text" runat="server" readonly="true" id="txt_XHSLX" style="width: 266px;margin-bottom:0px;background-color:transparent;"/>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 12%;vertical-align:middle;" class="td_justify"><span>维保单位</span></td>
                        ...
                        <td style="width: 12%;vertical-align:middle;" class="td_justify"><span>维保人员</span></td>
                        <td style="vertical-align:middle;">
                    ...
                    <tr>
                        <td style="width: 12%;vertical-align:middle;" class="td_justify"><span>维保时间</span></td>
                    ...
                    <tr>
                        <td style="width: 12%;vertical-align:middle;" class="td_justify"><span>保养内容</span></td>
                        <td colspan="3" style="vertical-align:middle;">
                    ...
                    <tr>
                        <td style="width: 12%;vertical-align:middle;" class="td_justify"><span>保养结果</span></td>
                        <td colspan="3" style="vertical-align:middle;">
                    ...
                    <tr>
                        <td style="width: 12%;vertical-align:middle;" class="td_justify"><span>备注</span></td>
                        <td colspan="3" style="vertical-align:middle;">
                    ...
                    <tr>
                        <td colspan="4" style="text-align: center; vertical-align: middle;" class="text-center">
                            <asp:Button ID="btnAdd" CssClass="btn btn-success btn-sm" runat="server" Text="保存" OnClick="btnAdd_Click"></asp:Button>
                        </td>
                    </tr>
                </table>
            </div>

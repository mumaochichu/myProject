<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="waterMeterEdit.aspx.cs" Inherits="Smart.Water.Web.WaterUser.waterMeter.waterMeterEdit" %>
    ...
    <form id="ProForm" runat="server" class="form-horizontal">
        <div id="content">
            <div id="content-header" style="margin-top: 10px">
                <div id="breadcrumb">
                    <a href="#" class="current" style="font-size: 12px">水表设备编辑</a>

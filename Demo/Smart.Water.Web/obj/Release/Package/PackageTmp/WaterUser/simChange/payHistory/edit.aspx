<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="Smart.Water.Web.WaterUser.simChange.payHistory.edit" %>
...
<head runat="server">
    ...
    <script>
        ...
        function Close() {
            window.location.href = "./payHistory.html?id=" + yshId;
        }
    ...
    <form id="ProForm" runat="server" class="form-horizontal">
        <div id="content">
            <div id="content-header" style="margin-top: 10px">
                <div id="breadcrumb">
                    <a href="#" class="current" style="font-size: 12px">通讯卡缴费记录修改</a>
            ...
            <div class="widget-box">
                <div class="widget-title">
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#tab1">通讯卡缴费记录信息</a></li>
                    </ul>
                </div>
                    ...
                    <div id="tab1" class="tab-pane active">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>备注:</td>
                                <td colspan="3">
                                    <input class="form-control" type="text" id="txt_BZ" runat="server" style="width: 100%" />
                                </td>
                            </tr>
                        </table>
                    </div>

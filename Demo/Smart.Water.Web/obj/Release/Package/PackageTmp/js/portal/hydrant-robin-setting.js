...
Robin.Setting.ArcGISMapServices = [
   ...
   {
       id: 'wsgx', name: '供水管线', url: 'http://192.168.70.6/ArcGIS/rest/services/FuYang/FYGX/MapServer',
       item: [
           {
...
Robin.Setting.PipeLayerInfos = [
    ...
    */
      ...
      {
          LayerName: "WS_WATERSOURCE",
          LayerType: "980103",
          LayerCode: "WS_WATERSOURCE",
          AliasName: "水源井",
          MapService: "",
          Icon: "",
          TemplatePath: "../js/Templates/WS_WATERSOURCE.htm",
          ScriptPath: "../js/Templates/WS_WATERSOURCE.js",
          CssPath: "../js/Templates/WS_WATERSOURCE.css",
...
Robin.Setting.MapAnalyse = {
    ...
    hydrant: {
        ...
        url: 'http://192.168.70.6/ArcGIS/rest/services/FuYang/FYGX/MapServer/26',
        defaultRadius: 200,
        fieldName: 'SUBSID',
        fieldValue: ['消火栓', '消火栓'],
        showFields: [{ name: 'ROADNAME', showName: '编号' },
            { name: 'EXP_NO', showName: '管点点号' },
            { name: 'PMA', showName: '材质' },
            { name: 'H', showName: '地面高' },
            { name: 'DEEP', showName: '井深' },
            { name: 'X', showName: 'X' },
            { name: 'Y', showName: 'Y' }]
    },
    route: {
...
Robin.Setting.GlobalSetting = {
    ...
    */
    ...
    CityCode: "140000",
    //webSocket服务器.  
    gprsSocketServer: 'ws://172.30.17.24:4502/',
    //webSocket服务器.  
    ...
    //轻量级地图，用于查询、定位等简单场景.  
    LightMap: {
        url: '/Tile/ArcGISREST/dydxnew.gis'
    },
    //坐标系.  
    //wkid: 3857,
    wkid: 2384,
   // wkid: 4326,
    ...
    timeout: 20000,
    //代理地址.  
   /// proxyUrl: Robin.Host.DirectPath() + "/proxy/proxy.ashx",
    proxyUrl: "http://172.30.16.165/Smart.Water.Web/proxy/proxy.ashx",
...
Robin.Setting.MapSetting = {
    ...
    //地图初始化缩放
    initExtent: {
        //xmin: 41392.54843333342,
        //xmax: 65776.54843333337,
        //ymin: 45433.275200000484,
        //ymax: 58268.74186666713
        //xmin: 484273.455213325,
        //xmax: 508790.107620928,
        //ymin: 722118.923685858,
        //ymax: 731792.771158551

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="maintenanceEdit.aspx.cs" Inherits="Smart.Water.Web.WaterUser.system.equipment.maintenanceEdit" %>
        ...
        <form id="ProForm" runat="server" class="form-horizontal">
            <div id="content">
                <div id="content-header" style="margin-top: 10px">
                    <div id="breadcrumb">
                        <a href="#" class="current" style="font-size: 12px">设备故障报修编辑</a>
                        ...
                        <div id="tab1" class="tab-pane">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>联系人电话:</td>
                                    <td>
                                        <asp:TextBox ID="txt_LXRDH" CssClass="form-control number" ReadOnly="true" runat="server"></asp:TextBox>
                                    </td>
                                    <td>管道口径(mm):</td>
                                    <td>

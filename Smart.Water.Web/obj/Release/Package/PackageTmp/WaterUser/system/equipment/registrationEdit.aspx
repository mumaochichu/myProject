<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrationEdit.aspx.cs" Inherits="Smart.Water.Web.WaterUser.system.equipment.registrationEdit" %>
    ...
    <form id="ProForm" runat="server" class="form-horizontal">
        <div id="content">
            <div id="content-header" style="margin-top: 10px">
                <div id="breadcrumb">
                    <a href="#" class="current" style="font-size: 12px">维修登记信息编辑</a>
                    ...
                    <div id="tab2" class="tab-pane active">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>维修结果:</td>
                                <td>
                                    <%--<asp:TextBox ID="txt_WXJG" CssClass="form-control required" runat="server"></asp:TextBox>--%>

  ...
  function(_jquery) {
    ...
    var DEFAULTS = {
      ...
      template: function template(options) {
        return '<div class="' + options.classes.base + ' ' + options.classes.base + '-' + options.direction + '"><div id="slidePanelContent" class="' + options.classes.content + '"></div></div>';
      },
      ...
      _createClass(View, [{
        ...
        value: function load(object) {
          ...
          function setContent(content) {
            ...
            if (object.jsList && object.jsList.length > 0) {
                for (var i = 0; i < object.jsList.length; i++) {
                    var myElement = document.createElement("script");
                    myElement.src = object.jsList[i];
                    myElement.type = "text/javascript";
                    document.getElementById("slidePanelContent").appendChild(myElement);
                }
            }
          }

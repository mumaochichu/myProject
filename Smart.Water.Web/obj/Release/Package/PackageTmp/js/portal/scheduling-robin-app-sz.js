...
RequireJS([
    ...
    "portal/scheduling-robin-setting-sz",
    "Framework/robin-mvvm",
    "portal/scheduling-robin-portal-sz"],//ArcGis javascript API
    function () {
...
function Application_Start() {
    ...
    $("#Modelshow").click(function () {
        if ($("#ModelToolDiv").css("display") === 'none') {
            $("#ModelToolDiv").show();
            $("#legendBoard").show();
        } else {
            $("#ModelToolDiv").hide();
    ...
    $("#ModelToolDiv").load("../Scheduling/Modelling/ModellingToolbar.html");
}

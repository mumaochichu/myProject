<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SBAdd.aspx.cs" Inherits="Smart.Water.Web.Scheduling.system.jyz.SBAdd" %>
            ...
            try{
                if (typeInfo == 'success') {
                    ...
                    window.setTimeout(function () {
                        top.Robin.CloseOneInfoPanel("SBAdd");
                    }, 1000);
                }
            }
            catch (e) {
          ...
          <%-- 水泵设备信息 --%>          
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td>水泵品牌</td>
                        <td>
                            <asp:TextBox ID="txt_SBPP" CssClass="form-control required" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>水泵型号</td>
                        ...
                        <td>水泵流量(m³/s)</td>
                        <td>
                            <asp:TextBox ID="TXT_SBLL" CssClass="form-control number" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>电机编号</td>
                    ...
                    <tr>
                        <td>电机功率(kW)</td>
                        <td>
                            <asp:TextBox ID="txt_DJGL" CssClass="form-control number " runat="server"></asp:TextBox>
                        </td>
                        <td>电机额定电流(A)</td>
                        <td>
                            <asp:TextBox ID="txt_DJEDDL" CssClass="form-control number" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>电机转速(r/min)</td>
                        <td>
                            <asp:TextBox ID="txt_DJZS" CssClass="form-control number " runat="server"></asp:TextBox>
                        </td>
                        <td>电机台数(台)</td>
                        <td>
                            <asp:TextBox ID="txt_DJTS" CssClass="form-control number " runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>水泵扬程(m)</td>
                        <td>
                            <asp:TextBox ID="txt_SBYC" CssClass="form-control number " runat="server"></asp:TextBox>
                        </td>
                        <td>安装时间</td>
                        <td>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:Button ID="btnAdd" runat="server"  Text="添加" CssClass="btn btn-info center-block" OnClick="btnAdd_Click" />
                        </td>
                    </tr>
                </table>
            </div>     

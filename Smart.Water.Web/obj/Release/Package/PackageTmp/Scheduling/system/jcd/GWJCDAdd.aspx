<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GWJCDAdd.aspx.cs" Inherits="Smart.Water.Web.Scheduling.system.jcd.GWJCDAdd" %>
            ...
            try {
                if (typeInfo == 'success') {
                    ...
                    window.setTimeout(function () {
                        parent.Robin.CloseOneInfoPanel("GWJCDAdd");                
                    }, 1000);
                }
            } catch (e) {
            }
